...
export const ROUTES: IntentRoute[] = [
  ...
  },
  {
    ...
    number: '04',
    label: 'Relocate',
    shortTitle: 'Land in Houston right',
    description:
      'Moving to Houston from anywhere — area orientation, timing, and a landing plan before you commit.',
    audience: "I'm new to Houston",
  ...
  },
  {
    ...
    audience: 'I own property (or want to)',
    href: '#manage',
    actionType: 'anchor',
    featured: true,
  },
  {
    ...
    description:
      'Not ready to pick a lane? Smart Move works for that too — answer a few questions and it points you in the right direction.',
